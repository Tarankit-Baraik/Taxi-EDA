...
```bash
pip install pandas numpy scipy geopandas matplotlib folium mapclassify jupyter
```

**2. Add the data**

Place the 12 monthly 2025 Yellow Taxi trip files, the TLC zone lookup CSV, and the TLC
zone shapefile under `data/raw/`, matching the paths expected by `src/data_loader.py`.
